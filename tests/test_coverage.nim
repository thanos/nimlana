...
suite "Borsh Deserialization Edge Cases":
  ...
  test "Deserialize u64 with insufficient data":
    var data: seq[byte] = @[0x01.byte, 0x02.byte, 0x03.byte, 0x04.byte, 0x05.byte]  # Only 5 bytes, need 8
    var offset = 0
    try:
  ...
  test "Deserialize u64 at boundary":
    var data: seq[byte] = @[0xEF.byte, 0xCD.byte, 0xAB.byte, 0x89.byte, 0x67.byte, 0x45.byte, 0x23.byte, 0x01.byte]
    var offset = 0
  ...
  test "Deserialize string with insufficient data":
    var data: seq[byte] = @[0x05.byte, 0x00.byte, 0x00.byte, 0x00.byte]  # Length=5 but no data
    var offset = 0
    try:
  ...
  test "Deserialize string with exact length":
    var data: seq[byte] = @[0x03.byte, 0x00.byte, 0x00.byte, 0x00.byte, 0x41.byte, 0x42.byte, 0x43.byte]
    var offset = 0
    let s = borshDeserializeString(data, offset)
    check s == "ABC"
    check offset == 7
